...
@Log4j
@AllArgsConstructor
public class InstagramUploadVideoJobRequest extends com.bfwg.instagram4j.requests.InstagramRequest<StatusResult> {
    ...
    @Override
    public com.bfwg.instagram4j.requests.payload.StatusResult execute() throws ClientProtocolException, IOException {
        ...
        log.info("User-Agent: " + com.bfwg.instagram4j.InstagramConstants.USER_AGENT);
        ...
        try (FileInputStream is = new FileInputStream(videoFile)) {
            ...
            return new com.bfwg.instagram4j.requests.payload.StatusResult("ok");
        }
    }
