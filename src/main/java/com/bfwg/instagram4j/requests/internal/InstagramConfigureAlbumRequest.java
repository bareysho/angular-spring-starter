...
public class InstagramConfigureAlbumRequest extends com.bfwg.instagram4j.requests.InstagramPostRequest<InstagramConfigureAlbumResult> {
    @NonNull
    ...
    @Override
    public com.bfwg.instagram4j.requests.payload.InstagramConfigureAlbumResult parseResult(int resultCode, String content) {
        return parseJson(resultCode, content, com.bfwg.instagram4j.requests.payload.InstagramConfigureAlbumResult.class);
    }
