...
@AllArgsConstructor
@Log4j
public class InstagramZeroRatingTokenRequest extends com.bfwg.instagram4j.requests.InstagramPostRequest<StatusResult> {
    ...
    public com.bfwg.instagram4j.requests.payload.StatusResult parseResult(int statusCode, String content) {
        return new com.bfwg.instagram4j.requests.payload.StatusResult();
    }
