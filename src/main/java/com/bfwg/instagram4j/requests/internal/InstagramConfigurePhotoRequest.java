...
@AllArgsConstructor
@Log4j
public class InstagramConfigurePhotoRequest extends com.bfwg.instagram4j.requests.InstagramPostRequest<InstagramConfigurePhotoResult> {
    ...
    @Override
    @SneakyThrows
    public com.bfwg.instagram4j.requests.payload.InstagramConfigurePhotoResult parseResult(int statusCode, String content) {
        return parseJson(statusCode, content, com.bfwg.instagram4j.requests.payload.InstagramConfigurePhotoResult.class);
    }
