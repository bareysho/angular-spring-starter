...
import com.bfwg.instagram4j.requests.payload.InstagramSearchLocationsResult;
...
public class InstagramSearchLocationsRequest extends InstagramGetRequest<InstagramSearchLocationsResult> {
	...
	public String getUrl() {
		return "location_search/?ig_sig_key_version=" + com.bfwg.instagram4j.InstagramConstants.API_KEY_VERSION
				+ "&search_query=" + query
