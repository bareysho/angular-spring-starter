...
import com.bfwg.instagram4j.requests.payload.InstagramGetUserFollowersResult;
...
public class InstagramGetUserFollowingRequest extends InstagramGetRequest<InstagramGetUserFollowersResult> {
    ...
    public String getUrl() {
        String baseUrl = "friendships/" + userId + "/following/?rank_token=" + api.getRankToken() + "&ig_sig_key_version=" + com.bfwg.instagram4j.InstagramConstants.API_KEY_VERSION;
