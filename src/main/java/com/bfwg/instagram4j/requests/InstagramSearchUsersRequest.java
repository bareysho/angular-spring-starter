...
import com.bfwg.instagram4j.requests.payload.InstagramSearchUsersResult;
...
public class InstagramSearchUsersRequest extends InstagramGetRequest<InstagramSearchUsersResult> {
    ...
    public String getUrl() {
        return "users/search/?ig_sig_key_version=" + com.bfwg.instagram4j.InstagramConstants.API_KEY_VERSION
