...
import com.bfwg.instagram4j.requests.payload.InstagramGetMediaCommentsResult;
...
public class InstagramGetMediaCommentsRequest extends InstagramGetRequest<InstagramGetMediaCommentsResult> {
	...
	public String getUrl() {
		String url = "media/" + mediaId + "/comments/?ig_sig_key_version=" + com.bfwg.instagram4j.InstagramConstants.API_KEY_VERSION;
