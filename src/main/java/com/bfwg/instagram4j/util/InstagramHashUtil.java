 ...
 */
package com.bfwg.instagram4j.util;
...
public class InstagramHashUtil {
    ...
    public static String generateSignature(String payload) {
        ...
        String signedBody = generateHash(com.bfwg.instagram4j.InstagramConstants.API_KEY, payload);

        return "ig_sig_key_version=" + com.bfwg.instagram4j.InstagramConstants.API_KEY_VERSION + "&signed_body=" + signedBody + '.'
                + parsedData;
